...
<html>
    ...
    <body>	
		...
		<div class="signupdiv">		 		  		
			...
			<legend align="center">
				<tr>				  				    
		            <td><h1 align="center" style="font-family:verdana;">Add Emplyee</h1></td>					
				</tr>
			</legend>
	 ...
	 <script>
	   ...
	   function validate(){
		...
		if(username.length<4){
			document.getElementById("err_uname").innerHTML = "<br> Username should have atleast 4 characters";
			return;
		}
